...
public class ControllerServiceJpa {
	...
	public void customerdetailinsertion(RegistrationData obj) throws ParseException {
		...
		accountdetailinsertion( obj);
	}
	
	public void accountdetailinsertion(RegistrationData obj) {
